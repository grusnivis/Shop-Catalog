...
DESCRIPTION : This program simulates a shop catalog where the user can input 
			  items (as a seller) and buy items from the said list (as a customer).
	...
	switch(choice.menuChoice){ //switch case for the menu choice
		case 1: { // menuChoice case 1 if the user is a seller
				...
				if ((strcmp(inputName, syapiSeller.username) == 0) && syapiSeller.PIN[80] == 123){ // condition if the username and pin are both correct
					...
					while (true){ //infinite loop if the user made a mistake in the input, i.e. catalog != 1 and 2. it will break if they will input 1 or 2
					printf("Input: ");
